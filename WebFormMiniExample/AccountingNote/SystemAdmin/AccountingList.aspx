        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:GridView ID="gvAccountingList" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvAccountingList_RowDataBound1">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="In/Out">
                                <ItemTemplate>
                                    ...
                                    <%--<asp:Literal ID="ltlAcType" runat="server"></asp:Literal>--%>
